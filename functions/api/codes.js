import {
  ...
  rateLimit, ipBucket, devicePlatform, deviceModel, deviceNom, deviceGeo, touchDevice, formatAddress, corrigerViaBAN, noterVisite, MAX_ADDRESS, MAX_CODE
} from './_lib.js';
...
export async function onRequestGet(context) {
  ...
  await touchDevice(db, me, devicePlatform(context.request), deviceModel(context.request), deviceNom(context.request), deviceGeo(context.request));
